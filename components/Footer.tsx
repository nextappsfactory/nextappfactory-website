...
export default function Footer() {
  return (
    <footer style={{ background: '#0F0F1A' }} className="text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-bold text-white text-sm">Huge App Factory</span>
            </div>
            <p className="text-sm text-gray-400 leading-relaxed mb-5 max-w-[220px]">
              Building the next generation of mobile experiences. Beautifully designed, robustly engineered.
            </p>
            {/* Social icons */}
          ...
          {/* Company */}
          <div>
            <div className="text-xs font-semibold uppercase tracking-widest text-gray-500 mb-4">Company</div>
            <ul className="space-y-3 text-sm text-gray-400">
              <li><Link href="/about" className="hover:text-white transition-colors">About Us</Link></li>
              <li><Link href="/apps-list" className="hover:text-white transition-colors">Our Apps</Link></li>
          ...
          {/* Legal */}
          <div>
            <div className="text-xs font-semibold uppercase tracking-widest text-gray-500 mb-4">Legal</div>
            <ul className="space-y-3 text-sm text-gray-400">
